...
public sealed record SubmittedFile
{
    ...
    private SubmittedFile(string fileName, string storageKey, long sizeBytes)
    {
        FileName = fileName;
    ...
    public static SubmittedFile Create(string fileName, string storageKey, long sizeBytes)
    {
        ...
        return new SubmittedFile(fileName.Trim(), storageKey, sizeBytes);
    }
}
